...
<!--                    <img :src="product.file_path" alt="{{product.name}}" style="height: 100px; width: 100px; word-break: keep-all" class="col-span-1 border-2 border-gray-600">-->
                ...
                <div class="flex flex-col items-start">
                    <h3 class="text-lg capitalize text-center text-gray-200 font-bold" v-text="product.name"></h3>
            ...
            <div class="col-span-1 col-start-3 row-start-1 mt-6">
                ...
                <div v-for="product in similarProducts" @click.prevent="showProduct(product)" class="bg-sky-800 my-4 border-2 border-white rounded flex cursor-pointer space-x-2">
                    <div>
                        <img :src="product.file_path" alt="{{product.name}}" style="height: 100px; width: 100px; word-break: keep-all" class="col-span-1 border-2 border-gray-600">
                    </div>
