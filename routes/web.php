...
Route::get('/checkout/summary', [CheckoutController::class, 'summaryIndex'])->middleware('auth');
Route::get('/checkout/summary/{order}', [CheckoutController::class, 'summaryShow'])->middleware('auth')->name('checkout.summary');
